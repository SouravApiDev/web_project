...
<?php
    if(isset($_POST['yt_url_link'])&&$_POST['yt_url_link'] != ""){
        ...
        if($decord != ""){
        echo '<div class="yt_title">'.$decord["title"].'</div><br><img class="image_thumbnail" src="'.$decord["thumbnail"].'"><br><br><div class="download_btn_list"><div class="center_align_download_btn">';
        ...
        elseif ($_POST['format']=="Audio") {
            ...
            echo '<div class="error_window"><div id="error_404"><center><h1 style="color: white">Please Enter Correct Link</h1></center><center><h4 style="color: white">https://www.youtube.com/watch?v=example</h4></center><center><h2 style="color: white">OR</h2></center><center><h4 style="color: white">https://youtu.be/example</h4></center></div></div>';
        }
    }
?>
</div>
