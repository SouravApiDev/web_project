...
if(isset($_GET['videoid'])){
    ...
    echo '<div id="center_align"><div id=""><iframe id="ytplayer" width="970" height="518" src="https://www.youtube.com/embed/'.$videoId.'?modestbranding=1&autoplay=1&rel=0" frameborder="0" allowfullscreen></iframe><div id="title"><div id="title"<h2 style="color: white; width: 890px; margin-left: 10px">'.$_GET['title'].'</h2><div style="display: flex; justify-content: right; align-items: right; margin-right: 40px"><button style="display: none" id="player_download">Download</button></div>';
